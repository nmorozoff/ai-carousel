...
const steps = [
  ...
  { num: "03", title: "Генерация", desc: "ИИ создаст тексты слайдов и визуальные описания за секунды." },
  { num: "04", title: "Скачайте результат", desc: "Получите готовые PNG слайды или промт для самостоятельной генерации." },
];
